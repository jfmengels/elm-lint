...
{-| Catch errors and return a new result generated by passing the error msg through callback.
-}
catch : (a -> Result b x) -> Result a x -> Result b x
...
{-| Parse source code into a AST
    ...
    If it fails the first time, remove comments and try again.
-}
